            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html"> <img src="/assets_public/img/logo.png" width="60" height="60" > Satya Lencana</a>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="fancy-hero-content text-center">
                        ...
                        <h2>Persyaratan Satya Lancana
                            <br> Provinsi Sulawesi Selatan
                        </h2>
                        <h2>Unduh</h2>
                        <a href="/filesyarat/{{ $data }}" class="btn fancy-btn fancy-active">Klik Disini</a>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="single-tweet">
                                <a href="#"> helpdesk@sulselprov.go.id
                                    ...
                                    Kota Makassar, Sulawesi Selatan <br>https://sulselprov.go.id </a>
