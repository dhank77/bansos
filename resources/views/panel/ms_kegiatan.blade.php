                ...
                <div class="panel-body">
                    <form method="POST" id="FormInsert" class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Kode</label>
                            <div class="col-sm-10">
                                <select class="form-control select2" id="KodeProgram" name="KodeProgram" style="width: 100%;" >
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Kode</label>
                            <div class="col-sm-10">
                                <input type="text" name="KodeKegiatan" class="form-control" required>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    <form method="POST" id="FormEdit" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Kode</label>
                                <div class="col-sm-10">
                                    <input type="text" id="KodeEdit" name="Kode" class="form-control" required disabled>
                                </div>
                            </div>
                            <div class="form-group"><label class="col-sm-2 control-label">Nama</label>
                                <div class="col-sm-10">
...
$(document).ready(function() {
    ...
    $("#KodeProgram").load('/load/data/ms_program');
    ...
    var table2 = $('#datatable-slide').DataTable({
            ...
            "serverSide": true,
            "ajax": "/panel/master/data/ms_kegiatan/json",
            "columns": [
...
function AjaxSimpanData() { 
    var data = $('#FormInsert').serialize();
        $.ajax({
            type: 'POST',
            url: '/panel/master/ms_kegiatan/insert',
            data: data,
            success: function() {
                alertSukses();
...
function AjaxEditData() { 
    var data = $('#FormEdit').serialize();
        $.ajax({
            type: 'POST',
            url: '/panel/master/ms_kegiatan/edit',
            data: data,
            success: function() {
                alertSukses();
                $('#datatable-slide').DataTable().ajax.reload();
...
function AjaxHapusData(id) { 
    var data = id;
        $.ajax({
            type: 'GET',
            url: '/panel/master/ms_kegiatan/delete/'+id,
            data: data,
            success: function() {
                alertSukses();
                $('#datatable-slide').DataTable().ajax.reload();
...
function EditData(id, kode, nama) { 
    ...
    document.getElementById("KodeEdit").value= kode;
}
